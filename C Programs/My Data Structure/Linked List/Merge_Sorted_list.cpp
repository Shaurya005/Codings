...
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2){
  SinglyLinkedListNode *ptr,*ptr1,*ptr2,*head;
  ...
  head=head2;ptr2=head2->next;}
  else if((head1->data)<(head2->data)){
  head=head1;ptr1=head1->next;}
  ptr=head;
...
int main()
{
    ...
    for (int tests_itr = 0; tests_itr < tests; tests_itr++) {
        SinglyLinkedList* llist1 = (SinglyLinkedList *)malloc(sizeof(SinglyLinkedList));
        llist1->head = NULL;
        llist1->tail = NULL;
        ...
        for (int i = 0; i < llist1_count; i++) {
      	...
      	SinglyLinkedList* llist2 = (SinglyLinkedList *)malloc(sizeof(SinglyLinkedList));
        llist2->head = NULL;
        llist2->tail = NULL;
