// Java program to find maximum product by breaking the Integer
class GFG {
	...
	{
		if (N == 2) // base case 2 = 1 + 1
			return 1;
		if (N == 3) // base case 3 = 2 + 1
			return 2;
		int maxProduct = -1;
