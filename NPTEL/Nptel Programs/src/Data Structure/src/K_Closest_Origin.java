...
public class K_Closest_Origin {
	...
	public static void main(String[] args) {
		...
		List<Coordinate> kClosestPointsUsingList =kClosestPointFromOriginUsingList(listOfCoordinate, 2);
		for(Coordinate c: kClosestPointsUsingList)
			System.out.println(c.x + " " + c.y);
		System.out.println();

		List<Coordinate> kClosestPointsUsingMinHeap = kClosestPointFromOriginUsingMinHeap(listOfCoordinate, 2);
		for(Coordinate c: kClosestPointsUsingMinHeap)
			System.out.println(c.x + " " + c.y);
		System.out.println();

		List<Coordinate> kClosestPointsUsingMaxHeap = kClosestPointFromOriginUsingMaxHeap(listOfCoordinate, 2);
